...
const [activePattern, setActivePattern] = useState<string>(
  ...
  return (
    <div
      className={`popup-container h-full tb:size selector-container reveal slide-up cc-pattern-selector-container pos-abs bottom-0 p-1 left-0 z-7 m-6 br-24${disabled ? " switcher-disabled" : ""}`}
      ref={containerRef}
    >
